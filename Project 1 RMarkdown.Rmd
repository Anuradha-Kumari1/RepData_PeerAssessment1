...
The mean of the total steps per day was `r mean_steps` and the median was `r median_steps`.
...
The maximum number of steps were taken in `r max_interval$interval` time interval.
...
The new mean of total steps taken is `r mean_steps_mod` and median is `r median_steps_mod`.
